	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				...
				<h2 class="title"><a href="#"><span class="style83 style35">Comments on Post  <span class="style91"><%=request.getParameter("p_Name")%></span> .. </span></a></h2>
		      <div class="entry">
...
%>
			      ...
			      <div align="center"><a href="A_PostsComments.jsp" class="style11"><strong>Back</strong></a></div>
		      </div>
		  </div>
	  </div>
		<!-- end #content -->
