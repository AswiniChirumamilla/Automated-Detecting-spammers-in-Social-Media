...
<title>All Purchased Items By Users..</title>
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				...
				<h2 class="title style30 style35"><a href="#" class="style36"><span class="style36 style35">All Purchased Users.. </span></a></h2>
			    <div class="entry">
				    ...
				    <table width="545" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                      ...
                      <%
						...
						try 
						{
						   	...
						   	String query="select distinct(user) from purchase"; 
                      ...
                      <tr>
                        ...
                        <td height="172" align="center"  valign="middle"><label>
						 <form id="form1" name="form1" method="post" action="A_PurchaseList.jsp">
                          <input type="hidden" value="<%=s2%>" name="username"/>
                         
                          <input type="submit" name="Submit" value="View Purchased Items" />
                          </label>  
						  </form>
					    </td>
                      </tr>
	  ...
	  <div id="sidebar">
		  <ul>
				  ...
				  <h2>Sidebar Menu</h2>
			        <p align="center"><a href="A_AllPurchase.jsp">Home</a></p>
