	...
	<div id="page-bgtop">
			...
			<div class="post">
			    ...
			    <div class="entry">
			      <table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
					...
					<tr>
                      <td   width="145" align="left" valign="middle" height="51" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style22 style36" style="margin-left:20px;"><strong>Account Type</strong></div></td>
		...
		<div id="sidebar">
			<ul>
					...
					<h2>Sidebar Menu</h2>
				      <p align="center"><a href="UserProfile.jsp">Home</a></p>
...
<div id="footer">
	<p class="style9">Automated Detecting Spammers In Social Media</p>
</div>
<!-- end #footer -->
