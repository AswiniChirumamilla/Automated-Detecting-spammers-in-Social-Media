...
.style13 {color: #00CC00; font-size: 12px; font-weight: bold; }
.style14 {
	color: #FF0000;
	font-weight: bold;
}
	...
	<div id="page-bgtop">
			  ...
			  <div class="entry">
				  <form id="form1" name="form1" method="post" action="AdminAuthentication.jsp">
					<table width="446" border="0" align="left" cellpadding="2" cellspacing="2">
                      <tr>
                        <td width="197" height="46" align="center"><span class="style13">
                          <label for="name">Name (required)</label>
                        </span> </td>
                        <td width="235"><input id="name" name="userid" class="text" /></td>
                      </tr>
                      <tr>
                        <td height="40" align="center"><span class="style13">Password (required)</span></td>
		...
		<div id="sidebar">
			<ul>
					...
					<h2>Sidebar Menu</h2>
				      <p align="center"><a href="AdminLogin.jsp">Home</a></p>
...
<div id="footer">
	<p class="style14">Automated Detecting Spammers In Social Media</p>
</div>
<!-- end #footer -->
