			    ...
			    <div class="entry">
			      <table width="592" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                    <tr>
                      ...
                      <td  width="81"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Account</div></td>
                    </tr>
                    ...
                    <%
						...
						try 
						{
						   	String query="select * from user where atype='"+ast+"' "; 
...
<div id="footer">
	<p class="style56">Automated Detecting Spammers In Social Media</p>
</div>
<!-- end #footer -->
