...
<title>Recommended Posts To User..</title>
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				...
				<h2 class="title style30 style35"><a href="#" class="style36"><span class="style36 style35">Posts Recommended by  <span class="style39"><%=request.getParameter("username")%>  </span>..</span></a></h2>
			    <div class="entry">
				    ...
				    <table width="545" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                      <tr>
                        ...
                        <td  width="176" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style55 style52 style5 style37 style38"><strong>Post  Image</strong></div></td>
                        <td  width="180" valign="middle" style="color: #2c83b0;"><div align="center" class="style52 style55 style5 style38 style37"><strong>Post Name</strong></div></td>
                      ...
                      <%
						...
						try 
						{
							...
							String username=request.getParameter("username");
						   	String strQuery9 = "select p_name,categorie from postrecommend where ( recommendto='"+user+"' and recommendfrom='"+username+"') ";
                      ...
                      <tr>
                        ...
                        <td height="172" align="center"  valign="middle"><label>
						 <form id="form1" name="form1" method="post" action="U_RecommendsToMe1.jsp">
                          <input type="hidden" value="<%=s2%>" name="p_Name"/>
						  <input type="hidden" value="<%=s3%>" name="p_Categorie"/>
						  <input type="hidden" value="<%=username%>" name="username"/>
                          <input type="submit" name="Submit" value="View Post Details" />
                          </label>  
						  </form>
					    </td>
                      </tr>
					...
					<div align="right"><a href="U_RecommendsToMe.jsp" class="style11"><strong>Back</strong></a></div>
			  </div>
		  </div>
	  </div>
		<!-- end #content -->
...
<div id="footer">
	<p class="style83">Automated Detecting Spammers In Social Media</p>
</div>
<!-- end #footer -->
