...
<title>Positive Comments On Post..</title>
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				...
				<h2 class="title"><a href="#"><span class="style83 style35">Positive Reviews on Post  <span class="style91"><%=request.getParameter("p_Name")%></span> .. </span></a></h2>
		      <div class="entry">
...
<%
			...
			%>
			      <table width="572" border="1" align="left" cellpadding="0" cellspacing="0" >
					 ...
					 <%
						int a=0;
						String str2="select * from poscomments where p_name='"+p_Name+"'  and categorie='"+p_Categorie+"'"; 
...
<div id="footer">
	<p class="style94">Automated Detecting Spammers In Social Media</p>
</div>
<!-- end #footer -->
