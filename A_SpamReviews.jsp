...
<title>Spam Reviews on Posts..</title>
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				...
				<h2 class="title style30 style35"><a href="#" class="style36"><span class="style36 style35">Spam Reviews on Posts..</span></a></h2>
			    <div class="entry">
				    ...
				    <table width="583" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                      ...
                      <tr>
                        ...
                        <td height="172" align="center"  valign="middle">
							<form id="form1" name="form1" method="post" action="A_Spams.jsp">
							<input type="hidden" value="<%=s2%>" name="p_Name"/>
							<input type="hidden" value="<%=s3%>" name="p_Categorie"/>							
                          <input type="submit" name="Submit" value="View Spam Reviews" />
                          </label>  
						  </form>	<br/>
