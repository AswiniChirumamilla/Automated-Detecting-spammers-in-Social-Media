	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				...
				<h2 class="title style30 style35"><a href="#" class="style36"><span class="style36 style35">Recommended Users To  <span class="style39"><%=application.getAttribute("uname")%>  </span>..</span></a></h2>
			    <div class="entry">
				    ...
				    <table width="545" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                      ...
                      <%
						...
						try 
						{
							...
							String user=(String)application.getAttribute("uname");
						   	String strQuery9 = "select distinct(recommendfrom) from postrecommend where ( recommendto='"+user+"') ";
                      ...
                      <tr>
                        ...
                        <td width="176" rowspan="1" align="center" valign="middle" ><div class="style54 style5 style22 style82 style40" style="margin:10px 13px 10px 13px;" ><strong>
                            <input  name="image" type="image" src="user_Pic1.jsp?username=<%=s2%>" style="width:150px; height:150px;" />
                        </strong></div></td>
                        ...
                        <td height="172" align="center"  valign="middle"><label>
						 <form id="form1" name="form1" method="post" action="U_RecommendsToMe12.jsp">
		...
		<div id="sidebar">
			<ul>
					...
					<h2>Sidebar Menu</h2>
				      <p align="center"><a href="U_RecommendsToMe.jsp">Home</a></p>
