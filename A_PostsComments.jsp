	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				...
				<h2 class="title style30 style35"><a href="#" class="style36"><span class="style36 style35">Microblogs Comments on Posts..</span></a></h2>
			    <div class="entry">
				    ...
				    <table width="583" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                      ...
                      <%
						...
						try 
						{
						   	...
						   	String strQuery9 = "select distinct(p_name),categorie from allcomments";
                      ...
                      <tr>
                        ...
                        <td align="center"  valign="middle"><div align="center" class="style22 style5 style20 style37 style54 style81">
                          <a href="S_PostDetails1.jsp?p_Name=<%=s2%>&amp;p_Categorie=<%=s3%>">
                          <%out.println(s2);%>
                          </a></div></td>
                        <td align="center"  valign="middle"><div align="center" class="style22 style5 style20 style37 style54 style81">
                        ...
                        <td height="172" align="center"  valign="middle">
							<form id="form1" name="form1" method="post" action="A_PostsComments1.jsp">
		...
		<div id="sidebar">
			<ul>
					...
					<h2>Sidebar Menu</h2>
				      <p align="center"><a href="A_PostsComments.jsp">Home</a></p>
