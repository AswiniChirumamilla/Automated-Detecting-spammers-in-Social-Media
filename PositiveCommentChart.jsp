...
<title>Positive Microblogs Comments Chart..</title>
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				...
				<h2 class="title style30 style35"><a href="#" class="style36"><span class="style36 style35">Positive <span class="style46">Review</span> Chart..</span></a></h2>
			    <div class="entry">
			      <iframe width="550" height="400" src="PosResults.jsp"></iframe>
			      <p>&nbsp;</p>
	  ...
	  <div id="sidebar">
		  <ul>
				  ...
				  <h2>Sidebar Menu</h2>
			        <p align="center"><a href="PositiveCommentChart.jsp">Home</a></p>
