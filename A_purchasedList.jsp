	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
			  ...
			  <h2 class="title"><a href="#"><span class="style12"><span class="style35"><span class="style30">User</span> <span class="style23"><%=request.getParameter("username")%><span class="style30">'s </span></span><span class="style30">Purchased products..</span></span></span></a></h2>
			    <div class="entry">
			      ...
			      <p>&nbsp;</p>
			      <div align="right"><strong><a href="A_AllPurchase.jsp">Back</a></strong></div>
			  </div>
		  </div>
	  </div>
		<!-- end #content -->
...
<div id="footer">
	<p class="style84">Automated Detecting Spammers In Social Media</p>
</div>
<!-- end #footer -->
